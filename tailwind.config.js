  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        '2xl': '64px',
        '3xl': '96px',
        'section': '128px', // Large spacing between major sections
        'my-section': '128px', // Margin top/bottom utility
        'py-section': '128px', // Padding top/bottom utility
        'px-section': '32px', // Side padding for sections
        'section-gap': '128px', // Section spacing
        'content-gap': '64px', // Content spacing
        'element-gap': '32px', // Element spacing
      },
      backdropBlur: {
        'enhanced': '16px',
        'glass': '20px',
